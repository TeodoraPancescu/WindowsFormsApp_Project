...
namespace WindowsFormsApp_Proiect_1.Extensions
{
    public static class DataGridViewExtension
    {
            ...
            public static DataGridView AddColumn(this DataGridView dataGrid, int index, string headerText, string dataPropertyName)
            {
